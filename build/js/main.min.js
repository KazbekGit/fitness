...
/* harmony import */ var _modules_iframe_creating__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/iframe-creating */ "./js/modules/iframe-creating.js");
/* harmony import */ var _modules_subscription_toggle__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/subscription-toggle */ "./js/modules/subscription-toggle.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_iframe_creating__WEBPACK_IMPORTED_MODULE_2__["addIframe"])();
  Object(_modules_subscription_toggle__WEBPACK_IMPORTED_MODULE_3__["toggleTabs"])();
  Object(_modules_swiper__WEBPACK_IMPORTED_MODULE_4__["addSwiper"])(); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
...
var videoSrc = 'https://www.youtube.com/embed/9TZXsZItgdw?autoplay=1&mute=1';
var videoContainer = document.querySelector('.gym__video');
var videoPlayButton = videoContainer.querySelector('.gym__play-button');
...
/***/ "./js/modules/subscription-toggle.js":
/*!*******************************************!*\
  !*** ./js/modules/subscription-toggle.js ***!
  \*******************************************/
...
var cards = document.querySelectorAll('.subscription__cards-price');
  ...
  tabs.forEach(function (currentTab) {
    currentTab.addEventListener('click', function () {
      if (!currentTab.classList.contains('subscription__tabs-item--active')) {
        ...
        var tabNumber = currentTab.getAttribute('data-number');
        var cardSelector = '.' + tabNumber;
        var currentCards = document.querySelectorAll(cardSelector);
